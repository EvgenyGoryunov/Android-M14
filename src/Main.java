...
//                    записать в файл output.txt сообщение в виде: 1-пунктирная линия, 2-дата
                    FileWriter qwe = new FileWriter("./output.txt", true);
//                    вписываем линию
                    qwe.write("\n------------------------------------------------------------------------------------" + "\n");
//                    вписываем дату
...
//               условие, при котором прописывается фраза шутка дня
                    ...
                    FileWriter messWrite = new FileWriter("./output.txt", true);
...
//                            выбранную случайную фразу прописываем в наш текстовый файл
                            FileWriter qwe1 = new FileWriter("./output.txt", true);
